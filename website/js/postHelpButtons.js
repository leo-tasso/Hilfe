...
function addMaterial() {
    ...
    newElement.innerHTML = '<label for= "oggetto' + newId + '" hidden> Oggetto </label> <input type="text" id="oggetto' + newId + '" name="oggetto" placeholder="Oggetto" /> <label for="quantita' + newId + '" hidden>Quantità</label> <input type="number" id="quantita' + newId + '" name="quantità" min="0" max="99" value="1" onchange="checkVariation(this)"/>';
