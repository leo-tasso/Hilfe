...
<head>
    ...
    <meta charset="UTF-8" />
<!-- link to add favicon-->
    <link rel="icon" type="image/x-icon" href="../res/HeartHands.png">
...
<body>
    <header>
        <nav class="top bar">
            <img src="../res/LogoHeart.png" alt="logo HILFE" />
    ...
    <main>
        ...
        foreach ($templateparams["articles"] as $article) : ?>
            <article>
                <header>
                    <h2><?php echo $article["TitoloPost"]; ?></h2>
                    <p><?php echo $article["DataPubblicazione"]; ?></p>
                </header>
                <section>
                    <p>
                        <?php echo $article["DescrizionePost"]; ?>
                    </p>
                </section>
