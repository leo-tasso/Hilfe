...
<article class="HelpPost" id="<?php echo $post["idPostIntervento"]; ?>,<?php echo $post["PersoneRichieste"]; ?>">
    <header>
        ...
        <div class="infoUtente">
            ...
            <?php if(isLogged() && $post["Autore_idUser"]==$_SESSION["idUser"]){echo '<a href="postHelpEdit.php?id='.$post["idPostIntervento"].'"><img class="penna" src="../Icons/Pen.svg" alt="modifica Post"></a>';}?>
        </div>
    </header>
    <div class="content">
        <section lang="ita">
...
<?php else:?>
    ...
    <header>
        ...
        <div class="infoUtente">
            ...
            <?php if(isLogged() && $post["idUser"]==$_SESSION["idUser"]){echo '<a href="postInfoEdit.php?id='.$post["idPostComunicazione"].'"><img class="penna" src="../Icons/Pen.svg" alt="modifica Post"></a>';}?>
        </div>
    </header>
